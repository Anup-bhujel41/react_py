                    ...
                    <div className="col-xl-9 col-lg-8 col-md-7 col-sm-12">
                        <div className="filter_wraps elspo_wrap d-flex align-items-center justify-content-end">
                            <div className="single_fitres elspo_filter mr-2 br-right">
                                <Link to="#filterBox" className="simple-button px-2" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="filterBox"><i className="lni lni-text-align-right mr-2"></i><span className="hide_mob">Filters</span></Link>
                            </div>
                            ...
                            <div className="single_fitres">
                                <Link to="shop-style-4.html" className="simple-button mr-1"><i className="ti-layout-grid3"></i></Link>
                                <Link to="shop-grid-3.html" className="simple-button mr-1"><i className="ti-layout-grid2"></i></Link>
                                <Link to="shop-list-view.html" className="simple-button active"><i className="ti-view-list"></i></Link>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                        ...
                                        <div className="single_filter_card mb-2">
                                            <h5><Link to="#mens" data-toggle="collapse" className="collapsed" aria-expanded="false" role="button">Men's<i className="accordion-indicator ti-angle-down"></i></Link></h5>
                                            <div className="collapse" id="mens" data-parent="#mens-categories">
                                                <div className="card-body">
                                                    <div className="inner_widget_link">
                                                        <ul className="m-0 p-0">
                                                            <li><Link to="#">Pumps & high Heals<span>112</span></Link></li>
                                                            <li><Link to="#">Sandels<span>82</span></Link></li>
                                                            <li><Link to="#">Sneakers<span>56</span></Link></li>
                                                            <li><Link to="#">Boots<span>101</span></Link></li>
                                                            <li><Link to="#">Casual Shoes<span>212</span></Link></li>
                                                            <li><Link to="#">Flats Sandel<span>92</span></Link></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="single_filter_card">
                                            <h5><Link to="#womens" data-toggle="collapse" className="collapsed" aria-expanded="false" role="button">Women's<i className="accordion-indicator ti-angle-down"></i></Link></h5>
                                    ...
                                    <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                        ...
                                        <div className="text-left pb-0 pt-2">
                                            ...
                                            <div className="form-check form-option form-check-inline mb-2">
                                                <input className="form-check-input" type="radio" name="sizes" id="a30" defaultChecked/>
