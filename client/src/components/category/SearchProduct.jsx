...
function withRouter(Component) {
  function ComponentWithRouter(props) {
    ...
    return <SearchProduct {...props} params={params} />;
  }
...
class SearchProduct extends Component {
  ...
  async componentDidMount() {
    await this.setState({
      search_query: this.props.params.query,
    });
    let res = await axiosInstance.post(`/search/`, {'search_q': this.state.search_query});
              ...
              <div className="row align-items-center justify-content-center">
                <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                  <div className="text-left py-5 mt-3 mb-3">
                    <h1 className="ft-medium mb-3">Search</h1>
...
const Search = withRouter(SearchProduct);
