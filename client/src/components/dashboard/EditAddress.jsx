...
function withRouter(Component) {
  function ComponentWithRouter(props) {
    ...
    return <EditAddress {...props} params={params} />;
  }
...
class EditAddress extends Component {
  ...
  async componentDidMount() {
    ...
    let res3 = await axiosInstance.get(`/address/${this.props.params.id}`);
    let data3 = await res3.data;
    if (data3.address.default) {
      this.setState({
        full_name: data3.address.full_name,
        phone_number: data3.address.phone_number,
        street_address: data3.address.street_address,
        apartment_address: data3.address.apartment_address,
        default: "true",
      });
    } else {
      this.setState({
  ...
  async handleSubmit(event) {
    ...
    try {
      let res = await axiosInstance.patch(`/address/${this.props.params.id}`, {
                  ...
                  <form method="post" onSubmit={this.handleSubmit}>
                    <div className="row">
                      <div className="col-12 col-lg-12 col-xl-12 col-md-12 mb-3">
                        <h4 className="ft-medium fs-lg">Update Your Address</h4>
                      </div>
                    </div>
                      ...
                      <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div className="form-group">
                          <input
                            ...
                            name="default"
                            type="checkbox"
                            checked={this.state.default === "true" ? true : false}
...
const UpdateAddress = withRouter(EditAddress);
